...
<div className="footer-content d-flex justify-content-between container text-white">
    <div style={{width:'400px'}} className="media mt-5">
        <h5 className='d-flex'><i style={{height:'25px'}} className="fa-solid fa-truck-fast text-light me-1"></i>E Cart</h5>
    ...
    <p className='text-center mt-3 text-white'>Copyright &copy; 2024 E Cart. Built with React.</p>    
       </div>
  )
}
